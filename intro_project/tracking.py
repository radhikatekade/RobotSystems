...
def run(img):
    ...
    output_image, center_x, center_y = get_output_image(frame_resize)
    ...
    #     frame_mask = cv2.inRange(frame_lab, tuple(target_color_range['min']), tuple(target_color_range['max']))  # Perform bit operations on the original image and mask
    ...
    # if area_max > 100:  # have found the maximum area
